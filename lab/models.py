...
class LabOrder(models.Model):
    ...
    result_file_base64 = models.TextField(blank=True, null=True)
    result_file_name = models.CharField(max_length=255, blank=True, null=True)
    result_file_type = models.CharField(max_length=100, blank=True, null=True)
